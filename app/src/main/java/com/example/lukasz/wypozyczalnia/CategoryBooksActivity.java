...
public class CategoryBooksActivity extends BaseActivity {
    ...
    public void onResume() {
        ...
        int id=getIntent().getIntExtra("category_id",category_id);
        if(id!=category_id) {
            category_id=id;
            helper.queryBooks("?category_id="+id,books,b_adapter);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper.queryBooks("?category_id="+category_id,books,b_adapter);
        book_list = (ListView) findViewById(R.id.list_category_books);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchView.OnQueryTextListener queryTextListener = new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                Intent next = new Intent(CategoryBooksActivity.this, SearchActivity.class);
